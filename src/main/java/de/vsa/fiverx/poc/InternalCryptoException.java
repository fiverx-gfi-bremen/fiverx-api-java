 ...
 * @since v1.0
 */
public class InternalCryptoException extends IllegalStateException {

    public InternalCryptoException() {
    }

    public InternalCryptoException(String s) {
        super(s);
    }
    ...
    public InternalCryptoException(Throwable cause) {
        super(cause);
    }
